"""
Comparison table for MirrorGame:
...
def main():
    ...
    for s in seeds:
        b = train_reinforce_mirror_game(seed=s)
        t = train_trp_reinforce_mirror_game(seed=s)
        r = train_trp_rsm_reinforce_mirror_game(seed=s)
    ...
    print("=== mirror_game summary (5 seeds) ===")
